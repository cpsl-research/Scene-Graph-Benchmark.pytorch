...
class PostProcessor(nn.Module):
    ...
    def forward(self, x, rel_pair_idxs, boxes):
        ...
        for i, (rel_logit, obj_logit, rel_pair_idx, box) in enumerate(zip(
            ...
            boxlist.add_field('labels', obj_class) # (#obj, )
            boxlist.add_field('scores', obj_scores) # (#obj, )
            ...
            # should have fields : rel_pair_idxs, pred_rel_class_prob, pred_rel_labels, labels, scores
            # Note
